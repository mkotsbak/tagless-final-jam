...
trait Module {
  ...
  /**
    * ContextShift is from cats-effect and allows asynchronous execution to be shifted
    * between thread pools. It is required in order for a [[cats.temp.par.Par]] instance for [[IO]]
    * to be available, and this is required by ReadingListServiceCompiler.
    */
